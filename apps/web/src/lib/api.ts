...
const ASSET_META: AssetMeta[] = [
  // ── tokenId 0-2: Original assets ─────────────────────────────────────────
  {
    id: 'sp-commercial-tower',
    name: 'São Paulo — Faria Lima Tower',
    tokenId: 0,
    yield_pct: 12.0,
  ...
  },
  {
    ...
    name: 'Gold Vault Reserve — Zurich',
    tokenId: 2,
    yield_pct: 8.5,
    category: 'commodity',
    location: 'Zurich, CH',
  ...
  // ── tokenId 3-8: New RWA assets ───────────────────────────────────────────
  {
    id: 'miami-sunset-bay',
    name: 'Miami Beach — Sunset Bay Residences',
    tokenId: 3,
    yield_pct: 15.0,
    category: 'real_estate',
  ...
  {
    id: 'manhattan-midtown-commerce',
    name: 'Manhattan — Midtown Commerce Tower',
    tokenId: 4,
    yield_pct: 9.5,
    category: 'real_estate',
  ...
  {
    id: 'dubai-marina-view',
    name: 'Dubai Marina — Marina View Tower',
    tokenId: 5,
    yield_pct: 18.0,
    category: 'real_estate',
    location: 'Dubai, UAE',
  ...
  {
    id: 'eu-corporate-bond-fund',
    name: 'EU Investment-Grade Corporate Bond Fund',
    tokenId: 6,
    yield_pct: 4.8,
    category: 'fixed_income',
  ...
  {
    id: 'silver-vault-zurich',
    name: 'Silver Vault Reserve — Zurich',
    tokenId: 7,
    yield_pct: 5.5,
    category: 'commodity',
    location: 'Zurich, CH',
  ...
  {
    id: 'london-grade-a-office',
    name: 'London — Grade-A Office Portfolio',
    tokenId: 8,
    yield_pct: 7.8,
    category: 'real_estate',
    location: 'London, UK',
